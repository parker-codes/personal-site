        ...
        {_.map(_.orderBy(_.filter(_.get(this.props, 'pageContext.pages'), ['frontmatter.home_spotlights.enabled', true]), 'frontmatter.home_spotlights.weight'), (spotlight_page, spotlight_page_idx) => (
          <section key={spotlight_page_idx}>
            {_.get(spotlight_page, 'frontmatter.home_spotlights.home_img') && (
              <a href={safePrefix(_.get(spotlight_page, 'url'))} className="image">
                <img src={safePrefix(_.get(spotlight_page, 'frontmatter.home_spotlights.home_img.path'))} alt="" data-position={_.get(spotlight_page, 'frontmatter.home_spotlights.home_img.data_position')} />
              </a>
            )}
            <div className="content">
              <div className="inner">
                ...
                <ul className="actions">
                  <li>
                    <a href={safePrefix(_.get(spotlight_page, 'url'))} className="button">
                      Learn more
                    </a>
                  </li>
                </ul>
