                                ...
                                {_.get(this.props, 'section.contact_list') && 
                                    _.map(_.get(this.props, 'section.contact_list'), (item, item_idx) => (
                                        <li key={item_idx}>
                                            ...
                                            {_.get(item, 'url') ? 
                                                <a href={_.get(item, 'url')}>{_.get(item, 'text')}</a>
                                             : 
                                                <span>{ReactHtmlParser(_.get(item, 'text').replace(/\n/g, '<br />'))}</span>
                                            }
                                        </li>
                                    ))
                                }
                                    ...
                                    <li>
                                        ...
                                        <ul className="icons">
                                            {_.map(_.get(this.props, 'section.social.social_icons'), (item, item_idx) => (
                                                <li key={item_idx}><a href={_.get(item, 'url')} className={_.get(item, 'icon')}><span className="label">{_.get(item, 'title')}</span></a></li>
                                            ))}
                                        </ul>
                                    </li>
                                }
